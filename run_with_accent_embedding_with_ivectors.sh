...
online_ivector_dir=exp/nnet3/ivectors_${trainSet}_sp
bnfNnetModelDir=/exp/abhinav/accent_recognizer_exp/nnet3/tdnn_1024nodes_300bnlayer_except_england_canada
affix=
train_stage=-10
bnf_dim=1024
...
if [ $ivector -eq 1 ]; then
  steps/online/nnet2/extract_ivectors_online.sh --cmd "$train_cmd" --nj $nj \
    data/${trainSet}_sp exp/nnet3/extractor $online_ivector_dir || exit 1;
fi
