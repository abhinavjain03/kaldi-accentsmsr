...
newName=finetune_cv_train_nz_8k_
# newName=finetune_cv_train_nz_ind+aus+us+eng4000
dir=exp/nnet3_msr/tdnn_d_${newName}sp

#for egs
num_utts_subset=100 #default is 512
samples_per_iter=10000 #default is 400000
...
if [ $decode -eq 1 ]; then
	...
	cvivectors=0
	swbdivectors=1
	decodeSets="test_cslu_cz test_cslu_hi" 
	# decodeSets="test_vctk_3accs cv_dev_nz_8k"
