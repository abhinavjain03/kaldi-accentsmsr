...
dir=${dir}$suffix
train_set=cv_train_everything$suffix 
ali_dir=exp/tri4_cv_train_everything_ali$suffix
#train_set=cv_train_nz$suffix
#ali_dir=exp/tri4_cv_train_nz_ali$suffix

local/nnet3/run_ivector_common_cv_train_everything.sh --stage $stage \
...
if [ $stage -le 11 ]; then
  ...
  ivectordev=0
  decodedev=1
  devsets="cv_test_onlyindian cv_dev_nz test_vctk_16k_10000 test_vctk_new_tmp_16k"
  # devsets="test_vctk_16k_10000 test_vctk_new_tmp_16k"
  # devsets="test_vctk_new_tmp_16k"
